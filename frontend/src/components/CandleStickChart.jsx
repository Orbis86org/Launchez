...
const CandleStickChart = () => {
    ...
    const options = {
        chart: {
            ...
            toolbar: {
                ...
                tools: {
                    ...
                    selection: false, // Disable selection button
                    zoom: true, // Enable zoom button
                    zoomin: true, // Enable zoom in button
                    zoomout: true, // Enable zoom out button
                    pan: true, // Enable pan button
                    reset: true, // Enable reset button
                    print: false // Disable print button
                },
                export: {
                    csv: false, // Enable CSV export
                    png: false, // Enable PNG export
                    svg: false, // Enable SVG export
                    jpeg: false // Enable JPEG export
                }
            }
        },
        title: {
        ...
        plotOptions: {
            candlestick: {
                colors: {
                    upward: '#3749E9',  // Color for upward candlesticks
                    downward: '#FF4560' // Color for downward candlesticks (example)
                }
            }
        }
    };
