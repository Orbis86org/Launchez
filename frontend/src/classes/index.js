...
(async () => {
    try {
        ...
        const tokenConfig = {
            name: "FairToken",
            symbol: "FTK",
            totalSupply: process.env.REACT_APP_HEDERA_TOKEN_TOTAL_SUPPLY0000000000, // 700 million tokens with 18 decimals
            decimals: 18,
        ...
        const initialSupply = process.env.REACT_APP_HEDERA_TOKEN_TOTAL_SUPPLY0000000000; // 700 million tokens with 18 decimals
