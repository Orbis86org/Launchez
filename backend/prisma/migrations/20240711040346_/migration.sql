/*
  ...
  - Added the required column `is_free` to the `games` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE `games` ADD COLUMN `is_free` BOOLEAN NOT NULL;
